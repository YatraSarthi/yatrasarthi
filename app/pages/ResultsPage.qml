...
Page {
    ...
    // Hide bottom bar when entering booking flow; restore when leaving
    Component.onCompleted: {
    if (appState) appState.showBottomBar = false  // ADD THIS LINE
    fetchEstimate()
}
Component.onDestruction: {                         // ADD THIS WHOLE BLOCK
